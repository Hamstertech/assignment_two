        ...
        <form class="w-96 mt-8 space-y-6" @submit="register">
            ...
            <div class="rounded-md shadow-sm -space-y-px">
                ...
                <div>
                    ...
                    <input id="token" name="token" type="text" autocomplete="token" required v-model="user.token" class="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-b-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" placeholder="Insert Token">
                </div>
            </div>
